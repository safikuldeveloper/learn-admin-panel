        ...
        <div class="sidebar">
               ...
               <div class="sidebar-body  custom-scrollbar">
                    <ul class="sidebar-menu">
                      ...
                      <li><a href="library.html" class="sidebar-link active"><i class="fa-solid fa-book"></i><p>Library</p></a></li>
          ...
          <div class="modal-content rounded-0">
            <div class="modal-body p-4 position-relative">
              ...
              <h2 class="h5 text-color-2 py-2">Create Library</h2>
                <form class="row g-3">
                    <div class="col-12">
                        <label for="UserName" class="form-label text-color-2 text-normal">Book Name</label>
                        <input type="text" class="form-control" id="UserName" placeholder="Enter book name">
                      </div>
                    <div class="col-12">
                    ...
                    <div class="col-12">
                        <label for="UserType" class="form-label text-color-2 text-normal">Status</label>
                        <select id="UserType" class="form-select text-normal">
